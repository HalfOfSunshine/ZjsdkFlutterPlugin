...
- [ZJSDK_iOS_Flutter使用文档 {ignore=true}](#zjsdk_ios_flutter使用文档-ignoretrue)
  - [<span id="jump1">一、iOS SDK接入说明</span>](#一ios-sdk接入说明)
    - [<span id="jump1.1">1.1、工程设置导入framework</span>](#11工程设置导入framework)
      ...
      - [<span id="jump1.1.2">1.1.2、导入framework</span>](#112导入framework)
    ...
    - [<span id="jump1.3">1.3、初始化SDK</span>](#13初始化sdk)
  - [<span id="jump2">二、加载广告</span>](#二加载广告)
    - [<span id="jump2.1">2.1、接入开屏广告(SplashAd)</span>](#21接入开屏广告splashad)
      - [<span id="jump2.1.1">2.1.1、开屏广告调用</span>](#211开屏广告调用)
      - [<span id="jump2.1.2">2.1.2、开屏广告回调说明</span>](#212开屏广告回调说明)
    - [<span id="jump2.2">2.2、接入激励视频(RewardVideoAd)</span>](#22接入激励视频rewardvideoad)
      - [<span id="jump2.2.1">2.2.1、激励视频调用</span>](#221激励视频调用)
      - [<span id="jump2.2.2">2.2.2、激励视频回调说明</span>](#222激励视频回调说明)
    - [<span id="jump2.3">2.3、接入插屏广告(InterstitialAd)</span>](#23接入插屏广告interstitialad)
      - [<span id="jump2.3.1">2.3.1、插屏广告调用</span>](#231插屏广告调用)
      - [<span id="jump2.3.2">2.3.2、插屏广告回调说明</span>](#232插屏广告回调说明)
    - [<span id="jump2.4">2.4、banner广告(BannerAd)</span>](#24banner广告bannerad)
      - [<span id="jump2.3.1">2.4.1、banner广告调用</span>](#241banner广告调用)
      - [<span id="jump2.3.2">2.4.2、banner广告回调说明</span>](#242banner广告回调说明)
    - [2.5、H5广告](#25h5广告)
      - [2.5.1、H5广告调用](#251h5广告调用)
      - [2.5.2、H5广告回调说明](#252h5广告回调说明)
